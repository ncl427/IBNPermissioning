...
// File contracts/sessionNFT.sol

pragma solidity ^0.8.2;

contract sessionSmartContract is
    Ownable,
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    ...
    
{
    ...
    constructor() ERC721("sessionSmartContract", "sessionNFT") {}

    function setBaseURI(string memory baseURI_) external onlyOwner {
        _baseURIextended = baseURI_;
    }

    function _createNftItem(uint tokenId, string memory tokenType) private{
    ...
    // The following function is for getting the map of owned tokens
    function getOwnedNfts(address target) public view returns (NftItem[] memory) {
        uint256 ownedItemsCount = ERC721.balanceOf(target);
        ...
        for (uint256 i = 0; i < ownedItemsCount; i++) {
            ...
            uint256 tokenId = tokenOfOwnerByIndex(target, i);
    ...
    {
        super._burn(tokenId);
        //Check if the struct has values and delete it after burning
        if (_idToNftItem[tokenId].valid) {
