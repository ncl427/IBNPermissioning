    ...
    ERC721Burnable
{
    ...
    constructor() ERC721("ottSmartContract", "ottNFT") {}

    function setBaseURI(string memory baseURI_) external onlyOwner {
        _baseURIextended = baseURI_;
    }

    function _createNftItem(uint256 tokenId, string memory exp) private{
